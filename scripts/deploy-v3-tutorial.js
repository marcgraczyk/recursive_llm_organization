...
const UNISWAP_V3_POOL_ABI = require("../node_modules/@uniswap/v3-core/artifacts/contracts/UniswapV3Pool.sol/UniswapV3Pool.json");
const UNISWAP_FACTOR_ABI = require("../node_modules/@uniswap/v3-core/artifacts/contracts/UniswapV3Factory.sol/UniswapV3Factory.json").abi;
const { Percent, Token } = require("../node_modules/@uniswap/sdk-core");
...
async function main() {
    ...
    var token0Address = "0x014f31e84328a6A134dcEF0F58FFB0947fC8a96C";
    var token1Address = "0xbC882cb8Fa7D5355c5FCEfe0BC5a97EB6D91D9e0";
    // (0.05, 0.3, 1, 0.01)
    var fee = (0.05) * 10000;
    ...
    const token0 = await new ethers.Contract(token0Address, ERC20Abi, provider);
    const token1 = await new ethers.Contract(token1Address, ERC20Abi, provider);
